...
class Company(models.Model):
    ...
    def new_registeration(self):
        ...
        send_mail(
            ...
            message="Congratulations a new company has registered for SOTM, Its name is "+self.company_name +
            ". Their email id is "+self.user.email +
            " . Please verify the company and make the change to backend.",
